<template>
    <div
        class="container vh-100 d-flex justify-content-center align-items-center py-3 bg-light"
    >
        <div class="col-lg-8 col-md-10 invoice-wrapper">
            ...
            <div
                v-if="bookingDetails"
                class="invoice-container card shadow-sm border-0"
            >
                <div class="invoice-header p-3 p-md-4">
                    <div class="row align-items-center">
                        <div
                            class="col-md-4 text-center text-md-start mb-3 mb-md-0"
                        >
                            <img
                    ...
                    <p class="text-center text-muted mb-0">
                        Thank you, {{ bookingDetails.renter.name }}! A
                        ...
                        <div class="col-md-7 mb-4 mb-md-0">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <address
                                        class="text-muted mb-0 small contact-info"
                                    >
                        ...
                        <div class="col-md-5">
                            <div class="summary-card p-3 rounded">
                                ...
                                >
                                    ...
                                    <span>{{
                                        formatPrice(
                                            bookingDetails.bike.dailyRate
                                        )
                                    }}</span>
                                </div>

                                <div
                                    class="total-section d-flex justify-content-between align-items-center mt-3 pt-3"
                                >
...
const goToBookings = () => router.push({ name: "MyBookings" });
