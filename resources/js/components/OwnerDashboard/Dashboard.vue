  ...
  <div class="owner-dashboard">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="#" @click.prevent="setActiveView('Store')" :class="{ active: activeView === 'Store' }">
...
import { faChartLine, faCog, faCalendarCheck, faWallet, faPlus, faBicycle, faSignOutAlt,faStore } from '@fortawesome/free-solid-svg-icons';
import ProfileIconDashboard from '../ProfileIconDashboard.vue';
...
// This approach lazy-loads the components, which is good for performance.
 const views = {
  ...
  Store: defineAsyncComponent(() => import('./Pages/StoreManagementView.vue')),
